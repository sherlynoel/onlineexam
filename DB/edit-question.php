...
<head>
        ...
        <title>GATE | Edit Question</title>
									 ...
									 print '
									  <form action="pages/update_question.php?type=mc" method="POST">
                                                ...
                                                <select class="form-control" name="topic" required>
									 														...
									 														include '../database/config.php';
																						 $sql = "SELECT * FROM tbl_topic WHERE exam_id = '$examid' ORDER BY topic";
																																																	$result = $conn->query($sql);
                                                ...
                                                </div><label for="exampleInputEmail1">Positive Marks</label>
                                                <input type="text" class="form-control" value="'.$pos.'" placeholder="Enter marks" name="positive" required autocomplete="off">
                                                </div>
																	<div class="form-group">
																	 <label for="exampleInputEmail1">Negative Marks</label>
                                                <input type="text" class="form-control" value="'.$neg.'" placeholder="Enter negative marks" name="negative" required autocomplete="off">
                                                </div>
