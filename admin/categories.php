...
<head>
        ...
        <title>GATE | Manage Categories</title>
                                        ...
                                        <div class="panel-body">
                                            <div role="tabpanel">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Subject</a></li>
                                                    <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Subject</a></li>
                                                    <li role="presentation"><a href="#tab7" role="tab" data-toggle="tab">Create Question Bank</a></li>
                                                    <li role="presentation"><a href="#tab8" role="tab" data-toggle="tab">Your Question Banks</a></li>
                                                </ul>
                                                ...
                                                <div class="tab-content">
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    ...
                                                                    while($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        print '
                                                                            ...
                                                                            <li>'.$stl.'</li>
                                                                            <li><a href="edit_subject.php?id='.$row['category_id'].'"> Edit Subject</a></li>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab7">
                                                        <form action="pages/add_questionbank.php" method="POST">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Question Bank name</label>
                                                                <input type="text" class="form-control" placeholder="Enter Name" name="qbname" required autocomplete="off">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Select Department</label>
                                                                <select class="form-control" name="department" required>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Choose Visibility</label>
                                                                <br>
                                                                <input type="radio" id="me" name="visibility" value="me">
                                                                <label for="me">Only Me</label><br>
                                                                <input type="radio" id="dept" name="visibility" value="deptartment">
                                                                <label for="dept">Only My department</label><br>
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    ...
                                                                    while($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        print '
                                                                            ...
                                                                            <td>'.$st.'</td>
                                                                            <td><div class="btn-group" role="group">
                                                                            <a  href="add-questions-1.php?qid='.$row['qb_id'].'"><button type="button" class = "btn btn-primary" style = "width : 153px;" >   Add questions    </button></a>
                                                                            <a href="view-questionbank.php?qid='.$row['qb_id'].'"><button type="button" class = "btn btn-success" style = "width : 153px;">   View questions   </button></a>
                                                                            <a'; ?> onclick = "return confirm('Drop <?php echo $row['qb_name']; ?> ?')" <?php print ' href="pages/delete_qb.php?id='.$row['qb_id'].'"><button type="button" class = "btn btn-danger" style = "width : 153px; margin-top : 5px;">Delete Question Bank</button></a>
                                                                            <a href="print-questionbank.php?qid='.$row['qb_id'].'"><button type="button" class = "btn btn-warning" style = "width : 153px ; margin-top : 5px;">  Print questions  </button></a>
                                                                            </div></td>
