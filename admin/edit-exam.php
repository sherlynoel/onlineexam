                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">totalmark </label>
                                            <input type="number" class="form-control" value="<?php echo"$extmark"; ?>" placeholder="Enter passmark" name="t_mark" required autocomplete="off">
                                        </div>
                                         <div class="form-group">
