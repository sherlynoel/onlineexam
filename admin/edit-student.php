                ...
                <div id="main-wrapper">
                    <div class="row">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										...
										<div class="amount_list">
                                                                                    <label for="g-male" class="gift_amount">Male</label>
                                            <input type="radio"  <?php if ($sdgender == "Male") { print ' checked '; } ?> name="gender" id="g-male" value="Male" required>
                                            <label for="g-female" class="gift_amount">Female</label>
                                            <input type="radio" <?php if ($sdgender == "Female") { print ' checked '; } ?> name="gender" id="g-female" value="Female" required>
                                        </div>
										<div class="form-group">
						...
						<div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo "$sdsem"; ?>" class="form-control" placeholder="Enter Semester" name="sem" required autocomplete="off">
                                        </div>
						<div class="form-group">
                                            <label for="exampleInputEmail1">Section</label>
                                            <input type="text" value="<?php echo "$sdsec"; ?>" class="form-control" placeholder="Enter Section" name="sec" required autocomplete="off">
                                        </div>
                                    ...
                                    <input value="<?php echo "$sddob"; ?>" type="text" class="form-control date-picker" name="dob" required autocomplete="off" placeholder="MM/DD/YYYY">
                                    </div>
