                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <form action="pages/add_question2.php?type=mc" method="POST" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter option 1" name="opt1" required autocomplete="off">
                                                                ...
                                                                <td><input type="radio" name="answer" id="op1" value="option1" required><label for="op1" class="gift_amount">Click Here</label></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="radio" name="answer" id="op2" value="option2" required><label for="op2" class="gift_amount">Click Here</label></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="radio" name="answer" id="op3" value="option3" required><label for="op3" class="gift_amount">Click Here</label></td>
											...
											<tr>
                                                ...
                                                <td><input type="radio" name="answer" id="op4" value="option4" required><label for="op4" class="gift_amount">Click Here</label></td>
