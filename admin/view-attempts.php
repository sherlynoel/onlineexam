                ...
                <div id="main-wrapper">
                    <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   <?php
										   include '../database/config.php';
										   $sql = "SELECT * FROM tbl_assessment_records WHERE exam_name = '$exam_name' AND student_id = '$student_id' ";
                                           $result = $conn->query($sql);
						...
						<td>'.$row['usn'].'</td>
                                                ...
                                                <td><a href="view_report.php?exid='.$row['exam_id'].'&sid='.$row['student_id'].'"><button type="button" class = "btn btn-success">View Report</button></a></td>
