        ...
        <div class="page-inner">
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li><a href="./">Home</a></li>
                        <li><a href="categories.php">Question Banks</a></li>
                        <li class="active"><?php echo "$qb_name"; ?></li>
                    </ol>
                </div>
            </div>
            <div id="main-wrapper">
...
<a href="add-questions-1.php?qid='.$qb_id.'"><button type="button" class = "btn btn-primary">Add questions</button></a>
...
print '
<div>
<a  class="btn btn-twitter m-b-xs"href="edit-question.php?id='.$row['question_id'].'&qid='.$qb_id.'"><i class="fa fa-pencil"></i></a>
<a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_question.php?id='.$row['question_id'].'&qid='.$qb_id.'"><i class="fa fa-trash-o"></i></a>
<br>
<br>

<p>Question Number: <b>'.$qno.'.</b><p><b>Positive Marks: </b>'.(htmlentities($posmarks)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
<b>Negative Marks:</b> '.(htmlentities($neg)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<b>Difficulty:</b> '.(htmlentities($diff)).'</p></div><br>Question: '.nl2br(htmlentities($qs), false).'<br>Answer: '.nl2br(htmlentities($ans), false).'</p>';
...
<br>
<br>
<p><b>QNo:</b> '.$qno.'<br><b>Positive Marks: </b>'.(htmlentities($posmarks)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Negative Marks:</b> '.(htmlentities($neg)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<b>Difficulty:</b> '.(htmlentities($diff)).'<br><br><b>Question :</b>'.nl2br(htmlentities($qs)).'</p>';
                                        if( $imgs == NULL){ }else{
...
print '
<p>1) '.htmlentities($op2).'</p>';
if (htmlentities($op3) != '_')
print '
<p>1) '.htmlentities($op3).'</p>';
if (htmlentities($op4) != '_')
print '
<p>1) '.htmlentities($op4).'</p>';
print '
...
<br>
<br>
<p><b>QNo:</b>'.$qno.'.</b><br><b>Positive Marks: </b>'.(htmlentities($posmarks)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Negative Marks:</b> '.(htmlentities($neg)).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<b>Difficulty:</b> '.(htmlentities($diff)).'<br><b>Question :</b>  '.nl2br(htmlentities($qs)).'</p>';
                                          if( $imgs == NULL){ }else{
print '<center><img src="data:image/jpeg;base64,'.base64_encode($imgs).'" class="img-responsive" alt="error" style="overflow:scroll"/></center>';
}if (htmlentities($op1) != '_')
print '
