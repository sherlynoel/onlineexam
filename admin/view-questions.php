                                    ...
                                    <div class="panel-body">
                                        <div class="tabs-below" role="tabpanel">
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.nl2br(htmlentities($qs), false).'</p>';
                                                                                          if( $imgs == NULL){ }else{
                                                                                          print '<img src="data:image/jpeg;base64,'.base64_encode($imgs).'" class="img-responsive" width="250" height="250" align="right"/>';
											...
											print '
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             <p><b>'.$qno.'.</b> '.nl2br(htmlentities($qs)).'</p>';
                                                                                        if( $imgs == NULL){ }else{
                                                                                          print '<img src="data:image/jpeg;base64,'.base64_encode($imgs).'" class="img-responsive" width="250" height="250" align="right"/>';
