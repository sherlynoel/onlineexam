...
$message = "Hello $myfullname, we received a request for your new password for the <b>Online Gate Examination System</b> account, therefore your password have been changed to <br><b style='font-size:20px;color:red;background-color:lightgrey;'>$new_password</b>";   
...
$mail->SMTPAuth = true;                               
$mail->Username = 'noorvikas123@gmail.com';           
$mail->Password = 'NoorVikas@123';                         
$mail->SMTPSecure = 'tls';                            
$mail->Port = 587;                                   

$mail->setFrom('noorvikas123@gmail.com', 'Admin');
$mail->addAddress($myemail , $myfullname);              
$mail->addReplyTo('noorvikas123@gmail.com', 'Admin');
