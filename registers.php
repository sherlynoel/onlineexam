...
<input type="text" class="form-control" placeholder="Enter USN ex: 1CR16CS001" name="usn" required autocomplete="off" 
         ...
         <!-- pattern="(1CR)[0-9][0-9][A-Z][A-Z][0-9][0-9][0-9]" -->
                ...
                <div class="form-group">
                <h4>Date of Birth</h4>
                        <input type="date" class="form-control"  name="dob"  required autocomplete="off" required>
                </div>  
...
<div class="form-group">
                <h4>Batch</h4>
                <input type="text" class="form-control" placeholder="Enter passout year " name="batch" autocomplete="off" >
                </div>
                    <h4>Course</h4>
		 ...
		 <input type="hidden" id="role" name="role" value="HA HA HA ! Gotcha">				
