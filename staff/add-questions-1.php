    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Add Questions - <?php echo "$qb_name"; ?></h3>
                                        ...
                                        <div role="tabpanel">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                    <form action="pages/add_question.php" method="POST"
                                                        ...
                                                        <input type="hidden" class="form-control" name="type" value="MC">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="radio" id="medium" name="difficulty"
                                                                value="medium">
                                                            <label for="dept">Medium</label><br>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab7">
                                                    <div class = "jumbotron" style="border : solid 0.5px lightgray ; padding : 10px; width :50%;">
                                                        ...
                                                        <form enctype="multipart/form-data"
                                                            action="./questionupload.php" method="post">
                                                            ...
                                                            <input type="hidden" name="qb_id"
                                                                value="<?php echo "$qb_id"; ?>">
                                                                <a href="questionTemplate.xlsx" download>
