...
<head>
    ...
    <title>GATE | Manage Notice</title>
                ...
                <div>
                    ...
                    <form action="pages/add_exam.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter exam duration" name="duration"
                                required autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Total mark </label>
                            <input type="number" class="form-control" placeholder="Enter total mark" name="t_mark"
                                required autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Total question </label>
                            <input type="number" class="form-control" placeholder="Enter no of question"
                                name="t_question" required autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Pass Percentage(%) </label>
                            <input type="number" class="form-control" placeholder="Enter the percentage" name="passmark"
                                required autocomplete="off">
                        </div>
