...
$sql = "SELECT * FROM tbl_assessment_records WHERE exam_name = '$exam_name'";
...
<head>
        ...
        <title>GATE | <?php echo "$exam_name" ?> Results :  <?php echo "$s_name" ?> </title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><?php echo "$exam_name" ?> Results : <?php echo "$s_name" ?></h3>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   <?php
										   include '../database/config.php';
										   $sql = "SELECT DISTINCT exam_id ,exam_name FROM tbl_assessment_records WHERE exam_name = '$exam_name'  ";
                                           $result = $conn->query($sql);
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
                                                $exid = $row['exam_id'];
                                                $sql = "SELECT date FROM tbl_assessment_records WHERE exam_id = '$exid'";
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <td><b>'.$date.'</b></td>
                                                <td><a href="download_data.php?eid='.$row['exam_id'].'" class="btn btn-success" value="Export">Download Results</a></td>
