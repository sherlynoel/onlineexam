                ...
                <div id="main-wrapper">
                    <div class="row">
                                    ...
                                    <div class="panel-body">
                                        <div class="tabs-below" role="tabpanel">
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
                                             ...
                                             <p>Topic '.$qno.'.<b> '.nl2br(htmlentities($topic), false).'</b></p>
																						 <p>Questions Alloted: '.$numq.'</p>';
																							
                        print '
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="change-topic.php?id='.$tid.'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_topic.php?id='.$tid.'&eid='.$exam_id.'"><i class="fa fa-trash-o"></i></a>
                       ...
                       print '
											 ...
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="change-topic.php?id='.$tid.'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this topic ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_topic.php?id='.$tid.'&eid='.$exam_id.'"><i class="fa fa-trash-o"></i></a>
                                             </div>
											';		
											}
                                            ...
                                            while($row = $result->fetch_assoc()) {
											if ($qno == "1") {
											print '<li role="presentation" class="active"><a href="#tab'.$qno.'" role="tab" data-toggle="tab">T'.$qno.'</a></li>';	
											}else{
											print '<li role="presentation"><a href="#tab'.$qno.'" role="tab" data-toggle="tab">T'.$qno.'</a></li>';		
											}
