...
<head>
        ...
        <title>GATE | Edit Department</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Edit Department - <?php echo "$depname"; ?> </h3>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                         <form action="pages/update_dep.php" method="POST">
										<div class="form-group">
                                            <label for="exampleInputEmail1">Department Name</label>
                                            <input type="text" value="<?php echo "$depname"; ?>" class="form-control" placeholder="Enter the department_name" name="dep_name" required autocomplete="off">
                                            <div>
                                                <input type="hidden" name="dep_id" value="<?php echo "$dep_id"; ?>">
                                       <button type="submit" class="btn btn-primary">Update <?php echo "$depname"; ?></button>
                                            </div>
                                                                                </div>
