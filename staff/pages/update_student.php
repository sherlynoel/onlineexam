...
$sql = "SELECT * FROM tbl_users WHERE email = '$email' AND user_id !='$student_id' ";
...
$sql = "UPDATE tbl_users SET first_name = '$fname', last_name = '$lname', gender = '$gender', dob = '$dob', email = '$email', sem_sec = '$sem-$sec', phone = '$phone', department = '$department'  WHERE user_id='$student_id'";
echo $sql ;
...
header("location:../students.php?rp=7823&sid=$student_id");
  ...
  header("location:../students.php?rp=1298&sid=$student_id");
}
