        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><span><img src="gate.png" alt="" height="50" width="130"></span></a>
                    </div>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>INFOSYS Student</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Student And Exam Information</h4>
                                </div>
...
<script>
	...
	data: [{
		...
		indexLabel: "{label} - {y}",
		dataPoints: [
			{ y: <?php echo "$c_ans"; ?>, label: "Correct Answers" },
			{ y: <?php echo "$w_ans"; ?>, label: "Wrong Answers" },
			{ y: <?php echo "$skipped"; ?>, label: "Skipped Answers" }
