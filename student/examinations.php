...
$sql = "SELECT * FROM tbl_examinations where exam_id in (select exam_id from tbl_exam_invites where user_mail = '$myemail')";
...
$status = $row['status'];
if ($status == "Active") {
// if($mydepartment == $row['department']){
$st = '<p class="text-success">ACTIVE</p>';
$stl = '<a class="btn btn-success" href="take-assessment.php?id='.$row['exam_id'].'">Take Assessment</a>';
// } else {
// $st = '<p class="text-danger">Active</p>'; 
// $stl = '<a class="btn btn-danger disabled" href="#">Not Your Exam</a>';
// }
}else{
